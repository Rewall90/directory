      ...
      <div className="grid grid-cols-1 gap-6 md:grid-cols-3 lg:grid-cols-4">
        {regions.map((region) => (
          <Link
            key={region.slug}
            href={`/${region.slug}`}
            className="group flex items-center justify-between rounded-lg border border-border-default bg-background-surface p-4 transition-all hover:border-primary hover:shadow-md"
          >
